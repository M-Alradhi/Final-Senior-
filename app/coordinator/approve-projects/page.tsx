        ...
        <DialogContent className="max-w-3xl rounded-xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">{selectedProject?.problemStatement || selectedProject?.description || t("noDescription")}</p>
            </div>
            ...
            {selectedProject?.objectives && (
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">{selectedProject.objectives}</p>
              </div>
            )}

            {selectedProject?.expectedOutcomes && (
              <div>
                <h4 className="font-semibold mb-2">{language === "ar" ? "النتائج المتوقعة:" : "Expected Outcomes:"}</h4>
                <p className="text-sm text-muted-foreground leading-relaxed">{selectedProject.expectedOutcomes}</p>
              </div>
            )}
            ...
            {selectedProject?.tools && (
              <div>
                ...
                <p className="text-sm text-muted-foreground leading-relaxed">{selectedProject.tools}</p>
              </div>
            )}
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-muted/50 rounded-lg">
                ...
                <p className="font-semibold">{selectedProject?.type === "one-course" ? t("oneCourse") : t("twoCourses")}</p>
              </div>
            </div>
                  ...
                  {selectedProject.teamMembers.map((member: any, index: number) => (
                    <div key={index} className="flex items-center justify-between p-3 bg-muted/50 rounded-lg border">
                      <div>
                        ...
                        {member.studentId && <p className="text-xs text-muted-foreground">{language === "ar" ? "الرقم الجامعي:" : "ID:"} {member.studentId}</p>}
                      </div>

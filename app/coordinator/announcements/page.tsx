...
import { collection, query, orderBy, getDocs, onSnapshot, addDoc, updateDoc, deleteDoc, doc, Timestamp } from "firebase/firestore"
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 space-y-2">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {announcement.scope && announcement.scope !== "other" && <Badge variant="outline">{getScopeLabel(announcement.scope)}</Badge>}
                      </div>

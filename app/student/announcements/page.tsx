...
import { collection, query, where, orderBy, getDocs, onSnapshot, getDoc, doc, type Timestamp } from "firebase/firestore"
    ...
    const fetchAnnouncements = async () => {
      ...
      try {
        ...
        const relevantGeneral = generalAnnouncements.filter((ann: any) => {
          ...
          if (scope === "other") return false // other scope hidden from students

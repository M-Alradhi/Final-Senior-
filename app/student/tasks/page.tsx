...
export default function StudentTasks() {
  ...
  const handleSubmitTask = async (e: React.FormEvent) => {
    ...
    if (hadFilesButNoUrls) {
      toast.error("فشل رفع الملفات (لا يوجد رابط). تأكد أن الرفع اكتمل قبل الإرسال.")
      return
    }
            ...
            <Tabs defaultValue="all" className="space-y-6">
              ...
              <TabsContent value="pending" className="space-y-6">
                {pendingTasks.length === 0 ? (
                  <Card><CardContent className="p-8"><p className="text-center text-muted-foreground">{t("noTasksYet")}</p></CardContent></Card>
                ) : (
              ...
              <TabsContent value="graded" className="space-y-6">
                {gradedTasks.length === 0 ? (
                  <Card><CardContent className="p-8"><p className="text-center text-muted-foreground">{t("noGradesYet")}</p></CardContent></Card>
                ) : (
